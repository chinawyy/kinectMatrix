...
using KinectHubDemo.Speech;
using KinectHubDemo.Utils;
...
namespace KinectHubDemo
{
    ...
    DependencyProperty.Register(
        ...
        private void SensorChooserUI_Loaded(object sender, RoutedEventArgs e)
        {
